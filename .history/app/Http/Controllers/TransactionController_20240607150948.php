...
class TransactionController extends Controller
{
    ...
    public function transaction_traitement(){
        ...
        $transaction->utilisateur = request->commande;
        $transaction->detail = request->commande;
        $transaction->par = request->commande;
        $transaction->montant = request->commande;
        $transaction->status = request->commande;
    }
